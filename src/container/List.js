...
export default class List extends Component {
    ...
    onPageChange=(page)=> { //page就是当前点击的页数
        console.log(page)
        var url = 'https://cnodejs.org/api/v1/topics/?tab=all&page='+page;
        this.setState({
            url : url
        },function(){
            fetch(this.state.url)
                ...
                <div className="liebiao">
                            {
                                this.state.data.map((item,idx)=>
                                    <li key={idx}>
                                        ...
                                        <span className="time">15分钟前</span>
                        ...
                        <div id="pages">
                            <Pagination defaultCurrent={1} total={100} onChange={this.onPageChange} key={this.pages}/>
                        </div>
            </div>
        )
    }
